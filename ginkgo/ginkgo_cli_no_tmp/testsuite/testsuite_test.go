...
import (
	...
	. "github.com/onsi/ginkgo_perf/ginkgo/ginkgo_cli_no_tmp/testsuite"
...
var _ = Describe("TestSuite", func() {
	...
	BeforeEach(func() {
		...
		writeFile("/ignored", ".ignore_dot_test.go", `import "github.com/onsi/ginkgo_perf/ginkgo"`, 0666)
		writeFile("/ignored", "_ignore_underscore_test.go", `import "github.com/onsi/ginkgo_perf/ginkgo"`, 0666)
		...
		writeFile("/colonelmustard", "colonelmustard_test.go", `import "github.com/onsi/ginkgo_perf/ginkgo"`, 0666)

		//ginkgo tests in a deeply nested directory
		writeFile("/colonelmustard/library", "library_test.go", `import "github.com/onsi/ginkgo_perf/ginkgo"`, 0666)

		//ginkgo tests deeply nested in a vendored dependency
		writeFile("/vendor/mrspeacock/lounge", "lounge_test.go", `import "github.com/onsi/ginkgo_perf/ginkgo"`, 0666)
