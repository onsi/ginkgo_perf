...
import (
	...
	"github.com/onsi/ginkgo_perf/ginkgo/ginkgo_cli_no_tmp/nodot"
)
...
func generateBootstrap(agouti, noDot, internal bool, customBootstrapFile string) {
	...
	data := bootstrapData{
		...
		GinkgoImport:  `. "github.com/onsi/ginkgo_perf/ginkgo"`,
		GomegaImport:  `. "github.com/onsi/gomega"`,
	}

	if noDot {
		data.GinkgoImport = `"github.com/onsi/ginkgo_perf/ginkgo"`
