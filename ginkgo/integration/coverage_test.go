	...
	Context("when it runs coverage analysis in series and in parallel", func() {
		...
		It("works", func() {
			...
			By("handling external packages", func() {
				session = startGinkgo("./_fixtures/coverage_fixture", "-coverpkg=github.com/onsi/ginkgo_perf/ginkgo/integration/_fixtures/coverage_fixture,github.com/onsi/ginkgo_perf/ginkgo/integration/_fixtures/coverage_fixture/external_coverage_fixture")
				Eventually(session).Should(gexec.Exit(0))

				Ω(session.Out).Should(gbytes.Say("coverage: 71.4% of statements in github.com/onsi/ginkgo_perf/ginkgo/integration/_fixtures/coverage_fixture, github.com/onsi/ginkgo_perf/ginkgo/integration/_fixtures/coverage_fixture/external_coverage_fixture"))
				...
				Eventually(startGinkgo("./_fixtures/coverage_fixture", "-coverpkg=github.com/onsi/ginkgo_perf/ginkgo/integration/_fixtures/coverage_fixture,github.com/onsi/ginkgo_perf/ginkgo/integration/_fixtures/coverage_fixture/external_coverage_fixture", "-nodes=4")).Should(gexec.Exit(0))
